...
# @allure.feature("Позитивные тесты для эндпоинта Пользователь Auth API")
# class TestUserAPIPositive:
#     @allure.story("Тест на создание пользователя")
...
#     @allure.story("Тест на получение информации о пользователе по ID или Email")
