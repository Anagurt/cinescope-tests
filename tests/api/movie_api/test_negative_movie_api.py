...
@allure.feature("Negative tests for movies API")
class TestMoviesAPINegative:
    ...
    def test_create_movie_by_registered_user(self, authorized_registered_user: ApiManager, movie_data: dict, registered_user: dict):
    ...
    def test_change_movie_with_empty_data(self, authorized_super_admin: ApiManager, created_movie_and_cleanup: dict):
        created_movie_id = created_movie_and_cleanup["id"]
        empty_name_movie_data = created_movie_and_cleanup.copy()
